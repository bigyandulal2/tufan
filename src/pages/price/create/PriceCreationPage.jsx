...
import { createPrice, loadAllCategory } from '../../../services/price';
import { getCurrentUserDetail } from '../../../auth';
import { useNavigate } from 'react-router-dom';
import Dropdown from '../../../components/ui/Dropdown';
import PriceInfo from './Createprice';

const PriceCreationPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await createPrice(userId, categoryId, priceData);
      ...
      <div className="border border-black rounded-[10px] p-6 min-h-[350px]">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Dropdown
            ...
            onChange={(e) => setCategoryId(e.target.value)} // Not the whole object!
            required
          />
...
export default PriceCreationPage;
